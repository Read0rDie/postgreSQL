...
<div class="col-s-2">
<button onclick="location.href='insertFaculty.jsp';" class="button"  type="button">Add New Faculty</button>
<button onclick="location.href='facultyUpdate.jsp';" class="button" type="button">Update Faculty</button>		
<button onclick="location.href='deleteFaculty.jsp';" class="button" type="button">Delete Faculty</button>		



<form class="centerTable" action="showF.jsp" method="POST">
...
<table class="centerTable" BORDER="1">
	<tr bgcolor="22a7f0"><th>ID#</th><th>Name</th><th>D.O.B.</th><th>Address</th><th>Email</th><th>Level</th></tr>
