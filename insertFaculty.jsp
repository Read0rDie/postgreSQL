...
<div class="table">
<h3 style="color:white;">New Faculty Record</h3>
</div>
<form name="stud"  class="table" action="insertFaculty.jsp" method="POST">
...
String faculty = "INSERT INTO faculties (faculty_id, name, date_of_birth, address, email, level) VALUES (?,?,?,?,?,?)";
...
id = count;
insert = connection.prepareStatement(faculty);
