...
<form name="del" action="deleteStudent.jsp" method="POST">

<div class="col-s-2">

<input onclick="location.href='students.jsp';" class="button" type="submit" name="submit" value="Delete"/>
...
String student = "DELETE FROM students WHERE student_id = ?";
int studInt;
