...
<form name="del" action="deleteCourse.jsp" method="POST">

<div class="col-s-2">

<input class="button" type="submit" name="submit" value="Delete"/>
<button onclick="location.href='courses.jsp';" class="button" type="button">Cancel</button>		
...
<% while (rs.next()){  %>
		<tr>
		<td><input type="radio" name="sid" value="<%= rs.getInt("course_id") %>"/></td>
...
String student = "DELETE FROM courses WHERE course_id = ?";
int studInt;
